...
import seminar_tasks.Task_2.my_exceptions.AmountException;
import seminar_tasks.Task_2.my_exceptions.CustomerException;
import seminar_tasks.Task_2.my_exceptions.ProductException;
...
public class Main {
    static Customer[] customers = {
            new Customer("Kuznetsova","Angela", "Sergeevna", "Angela@example.com"),
            new Customer("Shalapo","Robert", "Alexandrovich", "Robert@example.com"),
            new Customer("Smirnov","Bob", "Petrovich", "Bob@example.com")
    };
